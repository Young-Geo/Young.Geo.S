...
User *	Game::get_user_by_name(unsigned char *username)
{
	...
	if (ZERO == xmemcmp((char *)this->_user_1->get_username(), (char *)username, (USERNAME_LEN - 1)))
		return this->_user_1;
	if (ZERO == xmemcmp((char *)this->_user_2->get_username(), (char *)username, (USERNAME_LEN - 1)))
		return this->_user_2;
	if (ZERO == xmemcmp((char *)this->_user_3->get_username(), (char *)username, (USERNAME_LEN - 1)))
		return this->_user_3;
}
