...
User *	Game::get_user_by_name(unsigned char *username)
{
	...
	if (ZERO == xstrncmp((char *)this->_user_1->get_username(), username, USERNAME_LEN))
		return this->_user_1;
	if (ZERO == xstrncmp((char *)this->_user_2->get_username(), username, USERNAME_LEN))
		return this->_user_2;
	if (ZERO == xstrncmp((char *)this->_user_3->get_username(), username, USERNAME_LEN))
		return this->_user_3;
}
